  ...
  const conf = [
    {
      ...
      isLarge: true,
      region: 'US',
      limitSize: config.HETZNER_POOL_SIZE_LARGE.split(',')[1],
      minSize: config.HETZNER_POOL_SIZE_LARGE.split(',')[0],
    },
    {
      provider: 'Hetzner',
      isLarge: false,
      region: 'US',
      limitSize: config.HETZNER_POOL_SIZE.split(',')[1],
      minSize: config.HETZNER_POOL_SIZE.split(',')[0],
    },
    {
      provider: 'Hetzner',
      isLarge: true,
