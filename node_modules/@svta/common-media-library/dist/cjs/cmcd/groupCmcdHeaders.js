...
exports.groupCmcdHeaders = groupCmcdHeaders;
const CMCD_HEADER_MAP_js_1 = require("./CMCD_HEADER_MAP.js");
...
function groupCmcdHeaders(cmcd, customHeaderMap) {
    ...
    return keys.reduce((acc, key) => {
        var _a;
        const field = CMCD_HEADER_MAP_js_1.CMCD_HEADER_MAP[key] || custom[key] || CmcdHeaderField_js_1.CmcdHeaderField.REQUEST;
