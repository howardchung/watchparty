...
const parseTimestamp_js_1 = require("./parseTimestamp.js");
...
function parseCue(input, cue, regionList) {
    ...
    function consumeTimeStamp() {
        const ts = (0, parseTimestamp_js_1.parseTimeStamp)(input);
        if (ts === null) {
            throw new WebVttParsingError_js_1.WebVttParsingError(BAD_TIMESTAMP + oInput);
        }
    ...
    function consumeCueSettings(input, cue) {
        ...
        (0, parseOptions_js_1.parseOptions)(input, function (k, v) {
            switch (k) {
                case 'region': {
    ...
    if (input.substr(0, 3) !== '-->') { // (3) next characters must match "-->"
        throw new WebVttParsingError_js_1.WebVttParsingError(BAD_TIMESTAMP + " (time stamps must be separated by '-->'): ");
    }
