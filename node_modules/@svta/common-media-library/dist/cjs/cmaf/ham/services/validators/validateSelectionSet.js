...
exports.validateSelectionSet = validateSelectionSet;
const validateSwitchingSets_js_1 = require("./validateSwitchingSets.js");
/**
 ...
 *
 */
function validateSelectionSet(selectionSet, presentationId, prevValidation) {
    ...
    (0, validateSwitchingSets_js_1.validateSwitchingSets)(selectionSet.switchingSets, selectionSet.id, validation);
    return validation;
}
