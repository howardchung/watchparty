 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const R = "ok", P = "cancelled", V = "unknown", $ = "invalid-argument", N = "deadline-exceeded", D = "not-found", F = "already-exists", x = "permission-denied", S = "unauthenticated", q = "resource-exhausted", O = "failed-precondition", k = "aborted", C = "out-of-range", M = "unimplemented", L = "internal", j = "unavailable", U = "data-loss";
...
/** Credential provider for the Lite SDK. */ class K {
    ...
    getToken() {
        return this.auth ? this.auth.getToken().then((t => t ? (A("string" == typeof t.accessToken), 
        new z(t.accessToken, new m(this.auth.getUid()))) : null)) : Promise.resolve(null);
    }
    invalidateToken() {}
    start(t, e) {}
    shutdown() {}
...
/** AppCheck token provider for the Lite SDK. */ class X {
    constructor(t) {
    ...
    getToken() {
        return this.appCheck ? this.appCheck.getToken().then((t => t ? (A("string" == typeof t.token), 
        new J(t.token)) : null)) : Promise.resolve(null);
    }
    invalidateToken() {}
    start(t, e) {}
    shutdown() {}
 ...
 */
function wt() {
    return null === dt ? dt = 268435456 + Math.round(2147483648 * Math.random()) : dt++, 
    "0x" + dt.toString(16);
}
...
function vt(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? R : t >= 400 && t < 500 ? O : t >= 500 && t < 600 ? L : V;
    }
}
 ...
 */ (_t = gt || (gt = {}))[_t.OK = 0] = "OK", _t[_t.CANCELLED = 1] = "CANCELLED", 
...
class {
    ...
    v(t, e, n, r, s) {
        const i = wt(), o = this.I(t, e);
        _("RestConnection", `Sending RPC '${t}' ${i}:`, o, n);
        const u = {};
        return this.A(u, r, s), this.T(t, o, u, n).then((e => (_("RestConnection", `Received RPC '${t}' ${i}: `, e), 
        e)), (e => {
    ...
    async T(t, e, n, r) {
        ...
        try {
            ...
            const e = t;
            throw new B(vt(e.status), "Request failed with error: " + e.statusText);
        }
        if (!o.ok) {
            let t = await o.json();
            Array.isArray(t) && (t = t[0]);
            const e = null === (s = null == t ? void 0 : t.error) || void 0 === s ? void 0 : s.message;
            throw new B(vt(o.status), `Request failed with error: ${null != e ? e : o.statusText}`);
        }
        return o.json();
    }
}
...
function Nt(t) {
    try {
        ...
        throw t instanceof h ? new $t("Invalid base64 string: " + t) : t;
    }
}
    ...
    switch (n) {
      ...
      case 3 /* TypeOrder.TimestampValue */ :
        return function(t, e) {
            ...
            const n = xt(t.timestampValue), r = xt(e.timestampValue);
      ...
      case 9 /* TypeOrder.ArrayValue */ :
        return Rt(t.arrayValue.values || [], e.arrayValue.values || [], Ut);
...
function Qt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* TypeOrder.GeoPointValue */ :
        return function(t, e) {
            const n = Tt(St(t.latitude), St(e.latitude));
            if (0 !== n) return n;
            return Tt(St(t.longitude), St(e.longitude));
...
function zt(t, e) {
    ...
    const n = xt(t), r = xt(e), s = Tt(n.seconds, r.seconds);
    return 0 !== s ? s : Tt(n.nanos, r.nanos);
}
...
/** Creates a deep copy of `source`. */ function Jt(t) {
    ...
    if (t.mapValue) {
        ...
        return Vt(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Jt(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
...
class ee extends te {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* Operator.IN */ === e || "not-in" /* Operator.NOT_IN */ === e ? this.createKeyFieldInFilter(t, e, n) : new se(t, e, n) : "array-contains" /* Operator.ARRAY_CONTAINS */ === e ? new ce(t, n) : "in" /* Operator.IN */ === e ? new ae(t, n) : "not-in" /* Operator.NOT_IN */ === e ? new he(t, n) : "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ === e ? new le(t, n) : new ee(t, e, n);
    }
    static createKeyFieldInFilter(t, e, n) {
        return "in" /* Operator.IN */ === e ? new ie(t, n) : new oe(t, n);
    }
    matches(t) {
...
function re(t, e) {
    return t instanceof ee ? function(t, e) {
        return e instanceof ee && t.op === e.op && t.field.isEqual(e.field) && Ut(t.value, e.value);
    }(t, e) : t instanceof ne ? function(t, e) {
        if (e instanceof ne && t.op === e.op && t.filters.length === e.filters.length) {
            return t.filters.reduce(((t, n, r) => t && re(n, e.filters[r])), !0);
        }
        return !1;
    }
    /** Filter that matches on key fields (i.e. '__name__'). */ (t, e) : void I();
}
...
/** Filter that matches on key fields within an array. */ class ie extends ee {
    constructor(t, e) {
        super(t, "in" /* Operator.IN */ , e), this.keys = ue("in" /* Operator.IN */ , e);
    }
    matches(t) {
...
/** Filter that matches on key fields not present within an array. */ class oe extends ee {
    constructor(t, e) {
        super(t, "not-in" /* Operator.NOT_IN */ , e), this.keys = ue("not-in" /* Operator.NOT_IN */ , e);
    }
    matches(t) {
        return !this.keys.some((e => e.isEqual(t.key)));
    }
...
/** A Filter that implements the array-contains operator. */ class ce extends ee {
    ...
    matches(t) {
        const e = t.data.field(this.field);
        return Gt(e) && Bt(e.arrayValue, this.value);
    }
}
...
/** A Filter that implements the not-in operator. */ class he extends ee {
    constructor(t, e) {
...
/** A Filter that implements the array-contains-any operator. */ class le extends ee {
    constructor(t, e) {
        super(t, "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return !(!Gt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => Bt(this.value.arrayValue, t)));
    }
}
 ...
 */ class we {
    ...
    static min() {
        return new we(new Ot(0, 0));
    }
    static max() {
        return new we(new Ot(253402300799, 999999999));
    }
    compareTo(t) {
...
class me {
    ...
    insert(t, e) {
        return new me(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, ye.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new me(this.comparator, this.root.remove(t, this.comparator).copy(null, null, ye.BLACK, null, null));
    }
...
class ye {
    constructor(t, e, n, r, s) {
        this.key = t, this.value = e, this.color = null != n ? n : ye.RED, this.left = null != r ? r : ye.EMPTY, 
        this.right = null != s ? s : ye.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, r, s) {
        return new ye(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != r ? r : this.left, null != s ? s : this.right);
    }
    isEmpty() {
        return !1;
    }
    ...
    remove(t, e) {
        ...
        r = r.copy(null, null, null, r.left.remove(t, e), null); else {
            ...
            0 === e(t, r.key)) {
                if (r.right.isEmpty()) return ye.EMPTY;
...
class ge {
    constructor(t) {
        this.comparator = t, this.data = new me(this.comparator);
    }
    has(t) {
    ...
    getIterator() {
        return new _e(this.data.getIterator());
    }
    getIteratorFrom(t) {
        return new _e(this.data.getIteratorFrom(t));
    }
 ...
 */ class Ee {
     ...
     */    static newInvalidDocument(t) {
        return new Ee(t, 0 /* DocumentType.INVALID */ , 
        /* version */ we.min(), 
        /* readTime */ we.min(), 
        /* createTime */ we.min(), be.empty(), 0 /* DocumentState.SYNCED */);
    }
    /**
     * Creates a new document that is known to exist with the given data at the
     * given version.
     */    static newFoundDocument(t, e, n, r) {
        return new Ee(t, 1 /* DocumentType.FOUND_DOCUMENT */ , 
        /* version */ e, 
        /* readTime */ we.min(), 
        /* createTime */ n, r, 0 /* DocumentState.SYNCED */);
    }
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new Ee(t, 2 /* DocumentType.NO_DOCUMENT */ , 
        /* version */ e, 
        /* readTime */ we.min(), 
        /* createTime */ we.min(), be.empty(), 0 /* DocumentState.SYNCED */);
    }
     ...
     */    static newUnknownDocument(t, e) {
        return new Ee(t, 3 /* DocumentType.UNKNOWN_DOCUMENT */ , 
        /* version */ e, 
        /* readTime */ we.min(), 
        /* createTime */ we.min(), be.empty(), 2 /* DocumentState.HAS_COMMITTED_MUTATIONS */);
    }
    /**
     ...
     */    convertToFoundDocument(t, e) {
        ...
        return !this.createTime.isEqual(we.min()) || 2 /* DocumentType.NO_DOCUMENT */ !== this.documentType && 0 /* DocumentType.INVALID */ !== this.documentType || (this.createTime = t), 
     ...
     */    convertToNoDocument(t) {
        ...
        this.data = be.empty(), this.documentState = 0 /* DocumentState.SYNCED */ , this;
    }
    /**
     ...
     */    convertToUnknownDocument(t) {
        ...
        this.data = be.empty(), this.documentState = 2 /* DocumentState.HAS_COMMITTED_MUTATIONS */ , 
        this;
    }
    ...
    setHasLocalMutations() {
        return this.documentState = 1 /* DocumentState.HAS_LOCAL_MUTATIONS */ , this.version = we.min(), 
        this;
    }
    setReadTime(t) {
    ...
    isEqual(t) {
        return t instanceof Ee && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.documentType === t.documentType && this.documentState === t.documentState && this.data.isEqual(t.data);
    }
    mutableCopy() {
        return new Ee(this.key, this.documentType, this.version, this.readTime, this.createTime, this.data.clone(), this.documentState);
    }
    toString() {
 ...
 */ function $e(t) {
    ...
    if (null === e.q) {
        ...
        t.isKeyField() || e.q.push(new fe(t)), e.q.push(new fe(st.keyField(), "asc" /* Direction.ASCENDING */)); else {
            let t = !1;
 ...
 */ function Ne(t) {
    const e = T(t);
    if (!e.O) if ("F" /* LimitType.First */ === e.limitType) e.O = Ae(e.path, e.collectionGroup, $e(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.O = Ae(e.path, e.collectionGroup, t, e.filters, e.limit, n, r);
    }
    return e.O;
}

function De(t, e) {
    e.getFirstInequalityField(), Pe(t);
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ class Se {
    constructor() {
...
/** Transforms a value into a server-generated timestamp. */ class qe extends Se {}

/** Transforms an array value via a union operation. */ class Oe extends Se {
    constructor(t) {
        super(), this.elements = t;
    }
}

/** Transforms an array value via a remove operation. */ class ke extends Se {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function Xe(t, e) {
    return He(t, e.toTimestamp());
}

function Ze(t) {
    return A(!!t), we.fromTimestamp(function(t) {
        const e = xt(t);
        return new Ot(e.seconds, e.nanos);
    }(t));
}
...
function nn(t, e) {
    ...
    return new it((A((r = n).length > 4 && "documents" === r.get(4)), r.popFirst(5)));
    var r;
...
function un(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = nn(t, e.found.name), r = Ze(e.found.updateTime), s = e.found.createTime ? Ze(e.found.createTime) : we.min(), i = new be({
            mapValue: {
                fields: e.found.fields
            }
        });
        return Ee.newFoundDocument(n, r, s, i);
    }(t, e) : "missing" in e ? function(t, e) {
        A(!!e.missing), A(!!e.readTime);
        const n = nn(t, e.missing), r = Ze(e.readTime);
        return Ee.newNoDocument(n, r);
    }(t, e) : I();
}
...
function cn(t, e) {
    ...
    if (e instanceof Ue) n = {
        ...
        updateMask: mn(e.fieldMask)
    }; else {
        if (!(e instanceof ze)) return I();
        n = {
            verify: en(t, e.key)
        };
    }
...
function an(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = rn(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = rn(t, r.popLast()), n.structuredQuery.from = [ {
        collectionId: r.lastSegment()
    } ]);
    const s = function(t) {
        if (0 === t.length) return;
        return wn(ne.create(t, "and" /* CompositeOperator.AND */));
    }(e.filters);
...
function wn(t) {
    return t instanceof ee ? function(t) {
        ...
        const e = t.getFilters().map((t => wn(t)));
...
class gn {
     ...
     */ , s = 6e4) {
        this.C = t, this.timerId = e, this.M = n, this.L = r, this.j = s, this.U = 0, this.B = null, 
     ...
     */    K(t) {
        ...
        // honored as such).
        const e = Math.floor(this.U + this.Y()), n = Math.max(0, Date.now() - this.W), r = Math.max(0, e - n);
        // Guard against lastAttemptTime being in the future due to a clock change.
                r > 0 && _("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.U} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
        this.B = this.C.enqueueAfterDelay(this.timerId, r, (() => (this.W = Date.now(), 
        t()))), 
        // Apply backoff factor to determine next delay and ensure it is within
        // bounds.
        this.U *= this.L, this.U < this.M && (this.U = this.M), this.U > this.j && (this.U = this.j);
    }
    H() {
...
async function vn(t, e) {
    const n = T(t), r = sn(n.serializer) + "/documents", s = {
        writes: e.map((t => cn(n.serializer, t)))
    };
...
async function bn(t, e) {
    const n = T(t), r = sn(n.serializer) + "/documents", s = {
        documents: e.map((t => en(n.serializer, t)))
    }, i = await n.R("BatchGetDocuments", r, s, e.length), o = new Map;
    i.forEach((t => {
        const e = un(n.serializer, t);
...
async function En(t, e) {
    const n = T(t), r = an(n.serializer, Ne(e));
    return (await n.R("RunQuery", r.parent, {
        structuredQuery: r.structuredQuery
    })).filter((t => !!t.document)).map((t => function(t, e, n) {
        const r = nn(t, e.name), s = Ze(e.updateTime), i = e.createTime ? Ze(e.createTime) : we.min(), o = new be({
            mapValue: {
                fields: e.fields
            }
        }), u = Ee.newFoundDocument(r, s, i, o);
...
async function In(t, e, n) {
    var r;
    const s = T(t), {request: i, Z: o} = function(t, e, n) {
        const r = an(t, e), s = {}, i = [];
        let o = 0;
        return n.forEach((t => {
    ...
    }(s.serializer, Ne(e), n), u = i.parent;
...
function Tn(t) {
    ...
    if (!An.has(t)) {
        ...
        const i = function(t) {
            return new bt(t, fetch.bind(null));
        }((e = t._databaseId, n = t.app.options.appId || "", r = t._persistenceKey, s = t._freezeSettings(), 
        new Z(e, n, r, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, ft(s.experimentalLongPollingOptions), s.useFetchStreams))), o = yn(t._databaseId), u = function(t, e, n, r) {
            return new _n(t, e, n, r);
    ...
    constructor(t) {
        ...
        function(t) {
            if (void 0 !== t.timeoutSeconds) {
                if (isNaN(t.timeoutSeconds)) throw new B($, `invalid long polling timeout: ${t.timeoutSeconds} (must not be NaN)`);
                if (t.timeoutSeconds < 5) throw new B($, `invalid long polling timeout: ${t.timeoutSeconds} (minimum allowed value is 5)`);
                if (t.timeoutSeconds > 30) throw new B($, `invalid long polling timeout: ${t.timeoutSeconds} (maximum allowed value is 30)`);
            }
        }
        /**
 * @license
 ...
 */ function Nn(t, e, n, r = {}) {
    var s;
    const i = (t = ht(t, Pn))._getSettings(), o = `${e}:${n}`;
    if ("firestore.googleapis.com" !== i.host && i.host !== o && b("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."), 
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        t._authCredentials = new G(new z(e, n));
    }
}
 ...
 * terminated.
 */ function Dn(t) {
    return t = ht(t, Pn), e(t.app, "firestore/lite"), t._delete();
}
 ...
 */ class Sn {
    ...
    withConverter(t) {
        return new Sn(this.firestore, t, this._key);
    }
}
 ...
 */ class qn {
    ...
    withConverter(t) {
        return new qn(this.firestore, t, this._query);
    }
}
 ...
 */ class On extends qn {
    /** @hideconstructor */
    constructor(t, e, n) {
        super(t, e, new Te(n)), this._path = n, 
        /** The type of this Firestore reference. */
...
function kn(t, e, ...n) {
    if (t = d(t), ot("collection", "path", e), t instanceof Pn) {
        const r = nt.fromString(e, ...n);
        return ct(r), new On(t, /* converter= */ null, r);
    }
    {
        if (!(t instanceof Sn || t instanceof On)) throw new B($, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const r = t._path.child(nt.fromString(e, ...n));
        return ct(r), new On(t.firestore, 
        /* converter= */ null, r);
    }
}
 ...
 */ function Cn(t, e) {
    if (t = ht(t, Pn), ot("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new B($, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new qn(t, 
    /* converter= */ null, function(t) {
        return new Te(nt.emptyPath(), t);
    }(e));
}
...
function Mn(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = At.N()), ot("doc", "path", e), t instanceof Pn) {
        const r = nt.fromString(e, ...n);
        return ut(r), new Sn(t, 
        /* converter= */ null, new it(r));
    }
    {
        if (!(t instanceof Sn || t instanceof On)) throw new B($, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const r = t._path.child(nt.fromString(e, ...n));
        return ut(r), new Sn(t.firestore, t instanceof On ? t.converter : null, new it(r));
    }
}
 ...
 * Firestore database.
 */ function Ln(t, e) {
    return t = d(t), e = d(e), (t instanceof Sn || t instanceof On) && (e instanceof Sn || e instanceof On) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function jn(t, e) {
    return t = d(t), e = d(e), t instanceof qn && e instanceof qn && (t.firestore === e.firestore && Fe(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ class Un {
     ...
     */    static fromBase64String(t) {
        try {
            return new Un(Dt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new Un(Dt.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class Kn {
    constructor(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    toMutation(t, e) {
        return null !== this.fieldMask ? new Be(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Ue(t, this.data, e, this.fieldTransforms);
    }
}

/** The result of parsing "update" data (i.e. for an updateData call). */ class Yn {
    constructor(t, 
...
/** A "context" object passed around while parsing user data. */ class Jn {
    ...
    ct(t) {
        return yr(t, this.settings.methodName, this.settings.ht || !1, this.path, this.settings.lt);
    }
    ...
    it(t) {
        ...
        if (Hn(this.et) && Gn.test(t)) throw this.ct('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Xn {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.serializer = n || yn(t);
    }
...
function Zn(t) {
    const e = t._freezeSettings(), n = yn(t._databaseId);
    return new Xn(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function tr(t, e, n, r, s, i = {}) {
    const o = t.ft(i.merge || i.mergeFields ? 2 /* UserDataSource.MergeSet */ : 0 /* UserDataSource.Set */ , e, n, s);
    dr("Data must be an object, but it was:", o, r);
    const u = lr(r, o);
    let c, a;
    if (i.merge) c = new ve(o.fieldMask), a = o.fieldTransforms; else if (i.mergeFields) {
        const t = [];
        ...
        c = new ve(t), a = o.fieldTransforms.filter((t => c.covers(t.field)));
    } else c = null, a = o.fieldTransforms;
    return new Kn(new be(u), c, a);
}
...
class sr extends zn {
    ...
    _toFieldTransform(t) {
        const e = nr(this, t, 
        /*array=*/ !0), n = this.dt.map((t => hr(t, e))), r = new Oe(n);
...
class ir extends zn {
    ...
    _toFieldTransform(t) {
        const e = nr(this, t, 
        /*array=*/ !0), n = this.dt.map((t => hr(t, e))), r = new ke(n);
        return new Me(t.path, r);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class or extends zn {
    ...
    _toFieldTransform(t) {
        const e = new Ce(t.serializer, xe(t.serializer, this.wt));
...
/** Parse update data from an update() call. */ function ur(t, e, n, r) {
    const s = t.ft(1 /* UserDataSource.Update */ , e, n);
    dr("Data must be an object, but it was:", s, r);
    const i = [], o = be.empty();
    Vt(r, ((t, r) => {
        const u = pr(e, t, n);
    ...
    const u = new ve(i);
    return new Yn(o, u, s.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function cr(t, e, n, r, s, i) {
    const o = t.ft(1 /* UserDataSource.Update */ , e, n), u = [ wr(e, r, n) ], c = [ s ];
    ...
    for (let t = 0; t < i.length; t += 2) u.push(wr(e, i[t])), c.push(i[t + 1]);
    const a = [], h = be.empty();
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = u.length - 1; t >= 0; --t) if (!gr(a, u[t])) {
        const e = u[t];
        let n = c[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
    ...
    const l = new ve(a);
    return new Yn(h, l, o.fieldTransforms);
}
 ...
 */ function ar(t, e, n, r = !1) {
    return hr(n, t.ft(r ? 4 /* UserDataSource.ArrayArgument */ : 3 /* UserDataSource.Argument */ , e));
}
 ...
 */ function hr(t, e) {
    ...
    // from firestore-exp.
    t = d(t))) return dr("Unsupported field value:", e, t), lr(t, e);
    if (t instanceof zn) 
 ...
 */
    return function(t, e) {
        ...
        if (!Hn(e.et)) throw e.ct(`${t._methodName}() can only be used with update() and set()`);
...
function fr(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Ot || t instanceof Wn || t instanceof Un || t instanceof Sn || t instanceof zn);
}
 ...
 */ function wr(t, e, n) {
    ...
    // FieldPath.
    e = d(e)) instanceof Bn) return e._internalPath;
    if ("string" == typeof e) return pr(t, e);
    throw yr("Field path arguments must be of type string or ", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function pr(t, e, n) {
    if (e.search(mr) >= 0) throw yr(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new Bn(...e.split("."))._internalPath;
    } catch (r) {
        throw yr(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
...
/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function gr(t, e) {
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new vr(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
 ...
 */ function Er(t, e) {
    return t = d(t), e = d(e), t instanceof _r && e instanceof _r ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof br && e instanceof br && (jn(t.query, e.query) && Rt(t.docs, e.docs, Er));
}

/**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function Ir(t, e) {
    return "string" == typeof e ? pr(t, e) : e instanceof Bn ? e._internalPath : e._delegate._internalPath;
}
...
function Rr(t, e, ...n) {
    ...
    e instanceof Ar && r.push(e), r = r.concat(n), function(t) {
        const e = t.filter((t => t instanceof $r)).length, n = t.filter((t => t instanceof Pr)).length;
 ...
 */ class Pr extends Tr {
    ...
    _apply(t) {
        ...
        return Wr(t._query, e), new qn(t.firestore, t.converter, De(t._query, e));
    }
    _parse(t) {
 ...
 */ class $r extends Ar {
    ...
    _apply(t) {
        ...
        return 0 === e.getFilters().length ? t : (function(t, e) {
            ...
            for (const t of r) Wr(n, t), n = De(n, t);
        }
        // Checks if any of the provided filter operators are included in the given list of filters and
        // returns the first one that is, or null if none are.
        (t._query, e), new qn(t.firestore, t.converter, De(t._query, e)));
    }
 ...
 */ function Nr(...t) {
    ...
    return t.forEach((t => Kr("or", t))), $r._create("or" /* CompositeOperator.OR */ , t);
}
 ...
 */ function Dr(...t) {
    // Only support QueryFilterConstraints
    return t.forEach((t => Kr("and", t))), $r._create("and" /* CompositeOperator.AND */ , t);
}
 ...
 */ (t._query, this._field, this._direction);
        return new qn(t.firestore, t.converter, function(t, e) {
 ...
 */ class Sr extends Tr {
    ...
    _apply(t) {
        return new qn(t.firestore, t.converter, function(t, e, n) {
 ...
 */ class kr extends Tr {
    ...
    _apply(t) {
        const e = Br(t, this.type, this._docOrFields, this._inclusive);
        return new qn(t.firestore, t.converter, function(t, e) {
...
function Cr(...t) {
    return kr._create("startAt", t, 
    /*inclusive=*/ !0);
}

function Mr(...t) {
    return kr._create("startAfter", t, 
    /*inclusive=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function Br(t, e, n, r) {
    if (n[0] = d(n[0]), n[0] instanceof _r) return function(t, e, n, r, s) {
        ...
        // results.
                for (const n of $e(t)) if (n.field.isKeyField()) i.push(Wt(e, r.key)); else {
            const t = r.data.field(n.field);
            if (kt(t)) throw new B($, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, e, n, r, s, i) {
            ...
            for (let i = 0; i < s.length; i++) {
                ...
                if (o[i].field.isKeyField()) {
                    ...
                    if (!Ve(t) && -1 !== c.indexOf("/")) throw new B($, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r}() must be a plain document ID, but '${c}' contains a slash.`);
...
function Qr(t, e, n) {
    if ("string" == typeof (n = d(n))) {
        ...
        if (!Ve(e) && -1 !== n.indexOf("/")) throw new B($, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        ...
        return Wt(t, new it(r));
    }
    if (n instanceof Sn) return Wt(t, n._key);
...
function Kr(t, e) {
    if (!(e instanceof Pr || e instanceof $r)) throw new B($, `Function ${t}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
...
class Hr extends class {
    ...
    convertGeoPoint(t) {
        return new Wn(St(t.latitude), St(t.longitude));
    }
    convertArray(t, e) {
 ...
 * document contents.
 */ function Jr(t) {
    const e = Tn((t = ht(t, Sn)).firestore), n = new Hr(t.firestore);
    return bn(e, [ t._key ]).then((e => {
        A(1 === e.length);
        const r = e[0];
        return new _r(t.firestore, n, t._key, r.isFoundDocument() ? r : null, t.converter);
    }));
}
 ...
 */ function Xr(t) {
    !function(t) {
        if ("L" /* LimitType.Last */ === t.limitType && 0 === t.explicitOrderBy.length) throw new B(M, "limitToLast() queries require specifying at least one orderBy() clause");
    }((t = ht(t, qn))._query);
    const e = Tn(t.firestore), n = new Hr(t.firestore);
    return En(e, t._query).then((e => {
        const r = e.map((e => new vr(t.firestore, n, e.key, e, t.converter)));
        return "L" /* LimitType.Last */ === t._query.limitType && 
        // Limit to last queries reverse the orderBy constraint that was
        // specified by the user. As such, we need to reverse the order of the
        // results to return the documents in the expected order.
        r.reverse(), new br(t, r);
    }));
}

function Zr(t, e, n) {
    const r = Yr((t = ht(t, Sn)).converter, e, n), s = tr(Zn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
    return vn(Tn(t.firestore), [ s.toMutation(t._key, Le.none()) ]);
}

function ts(t, e, n, ...r) {
    const s = Zn((t = ht(t, Sn)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
        let i;
    i = "string" == typeof (e = d(e)) || e instanceof Bn ? cr(s, "updateDoc", t._key, e, n, r) : ur(s, "updateDoc", t._key, e);
    return vn(Tn(t.firestore), [ i.toMutation(t._key, Le.exists(!0)) ]);
}
 ...
 */ function es(t) {
    return vn(Tn((t = ht(t, Sn)).firestore), [ new Qe(t._key, Le.none()) ]);
}
 ...
 */ function ns(t, e) {
    const n = Mn(t = ht(t, On)), r = Yr(t.converter, e), s = tr(Zn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
    return vn(Tn(t.firestore), [ s.toMutation(n._key, Le.exists(!1)) ]).then((() => n));
}
 ...
 */ function ss(t, e) {
    const n = ht(t.firestore, Pn), r = Tn(n), s = function(t, e) {
        const n = [];
        for (const r in t) Object.prototype.hasOwnProperty.call(t, r) && n.push(e(t[r], r, t));
        return n;
    }(e, ((t, e) => new Et(e, t._aggregateType, t._internalFieldPath)));
 ...
 * @internal TODO (sum/avg) remove when public
 */ function os(t) {
    return new Fn("avg", wr("average", t));
}
 ...
 */ function cs(t, e) {
    var n, r;
    return t instanceof Fn && e instanceof Fn && t._aggregateType === e._aggregateType && (null === (n = t._internalFieldPath) || void 0 === n ? void 0 : n.canonicalString()) === (null === (r = e._internalFieldPath) || void 0 === r ? void 0 : r.canonicalString());
}
 ...
 */ class ms {
    ...
    set(t, e, n) {
        ...
        const r = ps(t, this._firestore), s = Yr(r.converter, e, n), i = tr(this._dataReader, "WriteBatch.set", r._key, s, null !== r.converter, n);
        return this._mutations.push(i.toMutation(r._key, Le.none())), this;
    }
    update(t, e, n, ...r) {
        this._verifyNotCommitted();
        const s = ps(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let i;
        return i = "string" == typeof (e = d(e)) || e instanceof Bn ? cr(this._dataReader, "WriteBatch.update", s._key, e, n, r) : ur(this._dataReader, "WriteBatch.update", s._key, e), 
     ...
     */    delete(t) {
        this._verifyNotCommitted();
        const e = ps(t, this._firestore);
        return this._mutations = this._mutations.concat(new Qe(e._key, Le.none())), this;
    }
    /**
 ...
 * writes.
 */ function ys(t) {
    const e = Tn(t = ht(t, Pn));
    return new ms(t, (t => vn(e, t)));
}
 ...
 */ class gs {
    ...
    async lookup(t) {
        ...
        const e = await bn(this.datastore, t);
    ...
    async commit() {
        ...
        })), await vn(this.datastore, this.mutations), this.committed = !0;
    }
    recordVersion(t) {
        let e;
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(we.min()) ? Le.exists(!1) : Le.updateTime(e) : Le.none();
    }
    /**
...
class vs {
    constructor(t, e, n, r, s) {
        ...
        this.deferred = s, this.yt = n.maxAttempts, this.gt = new gn(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */);
    }
    ...
    _t() {
        this.gt.K((async () => {
            const t = new gs(this.datastore), e = this.vt(t);
            e && e.then((e => {
    ...
    vt(t) {
        try {
            ...
            return !mt(e) && e.catch && e.then ? e : (this.deferred.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
 ...
 */ class Es {
     ...
     */    static createAndSchedule(t, e, n, r, s) {
        const i = Date.now() + n, o = new Es(t, e, i, r, s);
        return o.start(n), o;
    }
    /**
 ...
 */ class Is {
    constructor() {
        ...
        this.gt = new gn(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Dt = () => {
            const t = bs();
            t && _("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.gt.H();
        };
        const t = bs();
 ...
 */ (t);
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const r = Es.createAndSchedule(this, t, e, n, (t => this.qt(t)));
...
class As {
     ...
     */    get(t) {
        const e = ps(t, this._firestore), n = new Hr(this._firestore);
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return I();
            const r = t[0];
            if (r.isFoundDocument()) return new _r(this._firestore, n, r.key, r, e.converter);
            if (r.isNoDocument()) return new _r(this._firestore, n, e._key, null, e.converter);
            throw I();
        }));
    }
    set(t, e, n) {
        const r = ps(t, this._firestore), s = Yr(r.converter, e, n), i = tr(this._dataReader, "Transaction.set", r._key, s, null !== r.converter, n);
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = d(e)) || e instanceof Bn ? cr(this._dataReader, "Transaction.update", s._key, e, n, r) : ur(this._dataReader, "Transaction.update", s._key, e), 
 ...
 */ function Ts(t, e, n) {
    const r = Tn(t = ht(t, Pn)), s = Object.assign(Object.assign({}, _s), n);
    !function(t) {
        if (t.maxAttempts < 1) throw new B($, "Max attempts must be at least 1");
    }(s);
    const i = new Q;
    return new vs(new Is, r, s, (n => e(new As(t, n))), i).run(), i.promise;
}
 ...
 */ !function(t) {
    ...
    const r = t.getProvider("app").getImmediate(), s = new Pn(new K(t.getProvider("auth-internal")), new X(t.getProvider("app-check-internal")), function(t, e) {
