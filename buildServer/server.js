...
const releaseBatches = config_1.default.NODE_ENV === 'development' ? 1 : 10;
...
app.get('/downloadSubtitles', async (req, res) => {
    const response = await axios_1.default.get(req.query.url, {
...
async function getAllRooms() {
    ...
    return (await postgres_1.postgres.query(`SELECT * from room where "roomId" SIMILAR TO '${range}'`)).rows;
}
